      ...
      <div className="homeContainer-left">
        <div>
          <p className="home-title">
            ...
            <p>All Pets </p><img src={homepageDog} alt="Dog sitting"/>
            </div>
            Are Our
            <br />
            Priority
        ...
        <div className="adopt-btn">
          <Link to='./pets'><button className="Home-button" onClick={scrollToTop}><p>Wanna Adopt ?</p><img src={footPrint} alt="footprint" /></button></Link>
        </div>
      </div>
