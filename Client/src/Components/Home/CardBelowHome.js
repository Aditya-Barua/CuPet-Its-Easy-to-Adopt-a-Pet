...
const CardBelowHome = () => {
  ...
  return (
    <div className='dark-grey-container'>
      ...
      <div className='left-para'><p><p className='adopted-pets-num'>{adoptedPets}</p> Cute Furry Friends<br/>Living Their Best Lives</p></div>
      <div className='right-pic'><img src={HomeDarkCardRightPic} alt="Dog pic" /></div>
      <div className='right-para'><p className='we-do'>WHAT WE DO?</p>With a focus on matching the right pet with the right family, CuPet makes it easy to adopt love and foster happiness.</div>
    </div>
  )
}
